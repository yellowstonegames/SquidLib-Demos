...
//    public static final int bonusHeight = 0;
    ...
    private static final float
            ...
            FLOAT_BLOOD = Palette.FRESH_BLOOD,
            FLOAT_LIGHTING = floatGetHSV(0.17f, 0.12f, 0.8f, 1f),//-0x1.cff1fep126F, // same result as SColor.COSMIC_LATTE.toFloatBits()
            ...
            if (visible[pos.x][pos.y] > 0.1) {
                ...
                if (nextMovePositions != null && !nextMovePositions.isEmpty()) {
                    ...
                    if (tmp.x == player.x && tmp.y == player.y) {
                        ...
                        playerSprite.setColor(Palette.FRESH_BLOOD);
                        health--;
