...
public class MutantBatch implements Batch {
    ...
    public static final float FLOAT_WHITE = Color.WHITE.toFloatBits(), FLOAT_BLACK = Color.BLACK.toFloatBits();
    public float color = FLOAT_WHITE; // THIS IS PUBLIC BECAUSE PACKAGE-PRIVATE GOT US INTO THIS MESS!
    ...
    public void setColor (float r, float g, float b, float a) {
        color = NumberTools.intBitsToFloat(((int)(255 * a) << 24 & 0xFE000000)
