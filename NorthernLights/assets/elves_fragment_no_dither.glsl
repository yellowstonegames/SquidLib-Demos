...
void main()
{
    ...
    vec2 uv = (gl_FragCoord.xy * 0.25) + swayRandomized(COEFFS.zxy, (u_time * 0.1875) * COEFFS.yzx - gl_FragCoord.yxy * 0.01).xy * 42.0;
    ...
    gl_FragColor = vec4(swayRandomized(COEFFS + 3.0, con * 4.0) * 0.5 + 0.5, 1.0);
}