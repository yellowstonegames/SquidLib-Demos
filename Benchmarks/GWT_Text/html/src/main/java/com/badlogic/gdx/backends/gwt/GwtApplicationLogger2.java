 ...
 */
public class GwtApplicationLogger2 implements ApplicationLogger {

	private TextArea log;

	public GwtApplicationLogger2(TextArea log) {
		this.log = log;
	}
	...
	private void checkLogLabel () {
		if (log == null) {
			((GwtBareApp)Gdx.app).log = log = new TextArea();
			...
			((GwtBareApp)Gdx.app).getRootPanel().add(log);
		}
	}
