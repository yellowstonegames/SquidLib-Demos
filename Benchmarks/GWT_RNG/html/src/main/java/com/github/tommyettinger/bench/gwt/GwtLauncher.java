...
public class GwtLauncher extends GwtBareApp {
    ...
    public void start() {
        ...
        addIntTest(vp, new ChopRandom(123456789), "ChopRandom");
        addIntTest(vp, new Xoshiro128PlusPlusRandom(123456789), "Xoshiro128PlusPlusRandom");
        addIntTest(vp, new TrimRandom(123456789), "TrimRandom");
        addIntTest(vp, new FourWheelRandom(123456789), "FourWheelRandom");
        addIntTest(vp, new TricycleRandom(123456789), "TricycleRandom");
        addIntTest(vp, new RomuTrioRandom(123456789), "RomuTrioRandom");
        addIntTest(vp, new DistinctRandom(123456789), "DistinctRandom");
        addIntTest(vp, new LaserRandom(123456789), "LaserRandom");
        addIntTest(vp, new MizuchiRandom(123456789), "MizuchiRandom");
        addIntTest(vp, new StrangerRandom(123456789), "StrangerRandom");
        addIntTest(vp, new Xoshiro256StarStarRandom(123456789), "Xoshiro256StarStarRandom");
        ...
        addLongTest(vp, new ChopRandom(123456789), "ChopRandom");
        addLongTest(vp, new Xoshiro128PlusPlusRandom(123456789), "Xoshiro128PlusPlusRandom");
        addLongTest(vp, new TrimRandom(123456789), "TrimRandom");
        addLongTest(vp, new FourWheelRandom(123456789), "FourWheelRandom");
        addLongTest(vp, new TricycleRandom(123456789), "TricycleRandom");
        addLongTest(vp, new RomuTrioRandom(123456789), "RomuTrioRandom");
        addLongTest(vp, new DistinctRandom(123456789), "DistinctRandom");
        addLongTest(vp, new LaserRandom(123456789), "LaserRandom");
        addLongTest(vp, new MizuchiRandom(123456789), "MizuchiRandom");
        addLongTest(vp, new StrangerRandom(123456789), "StrangerRandom");
        addLongTest(vp, new Xoshiro256StarStarRandom(123456789), "Xoshiro256StarStarRandom");
