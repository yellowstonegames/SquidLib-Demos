 ...
 * that increments in a Weyl sequence, which is what Oriole32RNG does, and adding that instead of the golden
 * ratio, though this would have an unclear effect on the 4-dimensional equidistribution. XoshiroStarPhi32RNG is
 * optimized for GWT, like Lathe32RNG and {@link XoshiroStarStar32RNG}, which means any non-bitwise math in the
 ...
 * in the StarStar scrambler usually results in a binary rank failure in as little as 1GB of PractRand testing. As far
