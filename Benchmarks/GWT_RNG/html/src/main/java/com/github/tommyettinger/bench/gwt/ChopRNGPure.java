...
public final class ChopRNGPure extends AbstractRNG implements Serializable {
     ...
     */
    public ChopRNGPure(int stateA, int stateB, int stateC, int stateD) {
        this.stateA = stateA;
        this.stateB = stateB;
        this.stateC = stateC;
        this.stateD = stateD;
    ...
    public long previousLong() {
        ...
        return (long)((fb >>> 11 | fb << 21) ^ stateD - 0x5B6B62CA) << 32 | (fc & 0xFFFFFFFFL);
    }
    ...
    public int nextInt (int bound) {
        ...
        stateD = fd + 0xADB5B165 | 0;
        ////OLD
        //     (int) ((bound * ((long)next(31))) >> 31) & ~(bound >> 31);
        ////TWICE AS FAST! (On GWT, at least.)
        return (int)(bound * (long)(fc >>> 1) >>> 31) & ~(bound >> 31);
    }
    ...
    public double nextDouble() {
        ...
        stateC = ga ^ gb + gc;
        stateD = gd + 0xADB5B165 | 0;
        return ((fc & 0x1FFFFFL) << 32 | (gc & 0xFFFFFFFFL)) * 0x1p-53;
    }
    ...
    @Override
    public ChopRNGPure copy() {
        return new ChopRNGPure(stateA, stateB, stateC, stateD);
    }
    ...
    public boolean equals (Object o) {
        ...
        ChopRNGPure that = (ChopRNGPure)o;
