...
//    private char[][] political;
    ...
    public void create() {
        ...
        world = new WorldMapGenerator.TilingMap(seed, bigWidth, bigHeight, ClassicNoise.instance, 0.55);
        //world = new WorldMapGenerator.SphereMapAlt(seed, width, height, ClassicNoise.instance, 0.8);
        ...
        //world = new WorldMapGenerator.HyperellipticalMap(seed, width, height, ClassicNoise.instance, 0.8);//, 0.1, 3.25);
