/*
This demo needs these files in your project's assets folder:
...
They may be there already; if they aren't, you should download them to that directory to have the font show up.
If you want other fonts or resources that SquidLib can easily load, you can get the whole bunch in a zip:

https://github.com/SquidPony/SquidLib/raw/master/assets.zip

And then delete or move any files you don't need from there out of the assets folder.
*/
