...
/**
 * A utility that lets users build key remappings to fit their personal preferences or hardware requirements.
 */
public class KeyRemap extends ApplicationAdapter {
    ...
    public void create () {
        ...
        display = new SparseLayers(bigWidth, bigHeight, cellWidth, cellHeight,
                new TextCellFactory()
                        .fontMultiDistanceField("CascadiaMono-msdf.fnt", "CascadiaMono-msdf.png").setSmoothingMultiplier(2f));
        ...
        input = new SquidInput(new KeyHandler() {
            @Override
            public void handle(char key, boolean alt, boolean ctrl, boolean shift) {
