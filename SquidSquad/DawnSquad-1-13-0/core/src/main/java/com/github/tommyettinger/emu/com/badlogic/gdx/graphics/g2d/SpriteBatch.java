...
/**
 * Draws batched quads using indices. This is a drop-in replacement for SpriteBatch in libGDX, with some small fixes.
 * It also makes every field and method at least as available as {@code protected}, and often {@code public}, but never
 * {@code private} or "package-private". This last change is to ease subclassing, and to try to avoid needless copying
 * of SpriteBatch code, all 800+ lines of source code it has.
 *
 * @see Batch
 * @author mzechner
 * @author Nathan Sweet
...
public class SpriteBatch implements Batch {
	/**
	 * How many floats are used for one vertex.
	 */
	...
	/**
	 * The current batch color. The default shader uses this to tint rendered colors in a multiplicative way.
	 * Custom shaders can use it for whatever they want.
	 */
	public final Color color = new Color(1, 1, 1, 1);
	/**
	 * The current "packed float color" form of {@link #color}; this is what actually goes into the vertices.
	 */
